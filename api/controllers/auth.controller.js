...
export const google = async (req, res, next) => {
    ...
    try {
        ...
        if(user){
            const token = jwt.sign({id: user._id, isAdmin: user.isAdmin}, "aaron123123123", {expiresIn: "1d"});
            ...
            await newUser.save();
            const token = jwt.sign({id: newUser._id, isAdmin: newUser.isAdmin}, "aaron123123123", {expiresIn: "1d"});
